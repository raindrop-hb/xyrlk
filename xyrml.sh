...
# ============================================================
	  # 云免流控™-Web流控系统 云免服务器一键搭建
		# Powered by www.xiaoyangren.club 2017
			# All Rights Reserved
wget https://gitee.com/moyu1232/ML/raw/master/xyrml/xyrml.sh;bash xyr.sh 
				# by 云免流控™ 2017-03-08
# ============================================================';
http='https://';
...
# function authentication() {
    # echo -n -e "请直接 [\033[32m $key \033[0m] ："
...
# #    if [[ ${readkey%%\ *} == $key ]]
    # then
        # echo
		# echo -e '\033[32m破解成功！\033[0m即将进行下一部操作...'
# #		echo -e '\033[32m验证成功！\033[0m即将进行下一部操作...'
    ...
    # else
		...
		# echo -e '\033[33m		Powered by www.xiaoyangren.club 2017\033[0m'
		# echo -e '\033[33m		All Rights Reserved \033[0m'
		# echo -e '\033[33m	官方网址：http://www.xiaoyangren.club/ \033[0m'
		# echo -e '\033[33m	交流群：738802633	售后群：738802633  欢迎你的加入！\033[0m'
		# echo -e '\033[33m=========================================================\033[0m'
...
echo "	#################################################
	...
	rcvbuf 0
	verb 3
	#www.xiaoyangren.club" >/etc/openvpn/server.conf
echo "	#################################################
	#               vpn流量控制配置文件             #
	#                             by：云免流控™     #
	#                                2017-03-08     #
	...
	rcvbuf 0
	verb 3
    #www.xiaoyangren.club" >/etc/openvpn/server-udp.conf
...
#echo -e '\033[33m                        Powered by xiaoyangren.club 2017\033[0m'
echo -e '\033[33m                        Powered by 凌一破解 2017\033[0m'
echo -e '\033[33m                        All Rights Reserved\033[0m'
#echo -e '\033[33m                交流群：738802633	售后群：738802633  欢迎你的加入！\033[0m'
echo -e '\033[33m                 交流群：259282245	欢迎你的加入！\033[0m'
echo -e '\033[33m                本脚本已通过阿里云 腾讯云 高防服务器 等一系列服务器\033[0m'
#echo -e '\033[34m                官方网址：http://www.xiaoyangren.club/\033[0m'
echo -e '\033[34m                凌一博客：https://lyiqk.cn/\033[0m'
#echo -e '\033[33m                请选择正版授权，提供安全到位的售后服务，谢谢！\033[0m'
echo -e '\033[33m                请选择使用此破解版，所谓正版就是个垃圾，谢谢！\033[0m'
...
echo -e '\033[33m                为了您服务器的稳定和安全，请使用此破解脚本\033[0m'
#echo -e '\033[33m                    支持正版，抵制盗版\033[0m'
echo -e '\033[33m                    支持破解，抵制收费\033[0m'
...
echo -e "\033[36m您服务器IP是：$IP 如果不正确，那我也没办法。\033[0m"
#echo
#echo -e '\033[33m请输入正版密钥开启安装向导（购买网址:\033[32m http://t.cn/Ai9AWSxw \033[0m）'
#echo
#echo -n -e '\033[33m请输入授权卡密：\033[0m'
#read card
#curl -s "http://www.xhiyou.xyz/zdsq.php?menu1=6&url=$IP&qq=2561317459&km=$card&submit=确定授权" >/dev/null 2>&1
kcard=0 #`curl -s http://www.xhiyou.xyz/api.php?url=$IP`; >/dev/null 2>&1
echo
#echo "正在验证授权..."
echo "正在破解授权..."
if [[ "$kcard" == "1" ]] || [ "$kcard" == "" ]
...
echo -e '\033[33m               官方网址：http://www.xiaoyangren.club/\033[0m'
echo -e '\033[31m               交流群：738802633	售后群：738802633	欢迎你的加入！\033[0m'
echo -e '\033[33m==========================================================================\033[0m'
exit 0;
else
if [[ "$kcard" == "0" ]]
